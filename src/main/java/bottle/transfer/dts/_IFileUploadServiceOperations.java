 ...
 **/
public interface _IFileUploadServiceOperations
{
    /**
     * 请求上传文件
     * @param __current The Current object for the invocation.
     **/
    String request(FileUploadInfo fui, Ice.Current __current);
     ...
     * @param __current The Current object for the invocation.
     **/
    void transfer(String tag, long start, byte[] bytes, Ice.Current __current);
